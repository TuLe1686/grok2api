    ...
    translation: {
      ...
      settings: {
        ...
        accounts: {
          ...
          buildChatPermissionDeniedRequestDisable: "请求时禁用 Build chat 权限拒绝账号",
          buildChatPermissionDeniedRequestDisableHelp: "Grok Build 返回 chat endpoint permission-denied（403）时，立即停用整个 Build 账号，避免反复换号重试。仅影响 Build，不影响 Web/Console。",
          buildChatPermissionDeniedInspectEnabled: "定时巡检 Build chat 权限",
          buildChatPermissionDeniedInspectEnabledHelp: "按周期探测已启用的 Build 账号；命中 chat permission-denied 则自动停用。",
          buildChatPermissionDeniedInspectInterval: "Build 巡检间隔",
          buildChatPermissionDeniedInspectIntervalHelp: "定时探测间隔，支持 1 分钟至 24 小时。",
          buildChatPermissionDeniedInspectConcurrency: "Build 巡检并发",
          buildChatPermissionDeniedInspectConcurrencyHelp: "同时探测的 Build 账号数上限（1–32），实际还受凭据刷新并发池限制。",
        },
